      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 pb-24">
        ...
        {showInfo && (
          <p className="mt-4 rounded-xl bg-elevated p-3 text-[11px] leading-relaxed text-muted-foreground">
            Le plan ne propose que des lignes que vous détenez déjà, classées
            par leur rapport rendement/risque passé (performance annualisée,
            Sharpe, pire baisse) et leur tendance actuelle. Les lignes en signal
            Alléger sont écartées. L'épargne de précaution n'est renforcée que
            tant qu'elle reste sous {BUFFER_MONTHS} mois de revenus. Ces
        ...
        {buffer.months !== undefined && (
          ...
          >
            ...
            <span className="font-semibold">{buffer.months.toFixed(1)} mois</span> de revenus.
            {buffer.sufficient
