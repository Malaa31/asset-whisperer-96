...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-DrR7lpeZ.js
var server_DrR7lpeZ_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cm34NCRe.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CPppA-3k.mjs").then((n) => n.t),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_DrR7lpeZ_exports as t };
