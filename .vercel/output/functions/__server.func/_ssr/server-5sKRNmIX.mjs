...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-5sKRNmIX.js
var server_5sKRNmIX_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DuvGwHJP.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BqKF7lMf.mjs").then((n) => n.t),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_5sKRNmIX_exports as t };
